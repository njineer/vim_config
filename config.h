...
static char font[] = "Literation Mono Powerline:pixelsize=14:antialias=true:autohint=true";
//static char font[] = "Anonymice Powerline:pixelsize=14:antialias=true:autohint=true";
//static char font[] = "Cousine Powerline:pixelsize=14:antialias=true:autohint=true";
...
//static char font[] = "Inconsolata-dz for Powerline:pixelsize=14:antialias=true:autohint=true";
//static char font[] = "Inconsolata-g for Powerline:pixelsize=14:antialias=true:autohint=true";
//static char font[] = "Meslo for Powerline:pixelsize=14:antialias=true:autohint=true";
//static char font[] = "Sauce Code Powerline:pixelsize=14:antialias=true:autohint=true";
//static char font[] = "Symbol Neu Powerline:pixelsize=14:antialias=true:autohint=true";
//static char font[] = "Terminess Powerline:pixelsize=14:antialias=true:autohint=true";
//static char font[] = "Tinos Powerline:pixelsize=14:antialias=true:autohint=true";
//static char font[] = "Ubuntu Mono derivative Powerline:pixelsize=14:antialias=true:autohint=true";
//static char font[] = "Monofur for Powerline:pixelsize=14:antialias=true:autohint=true";
//static char font[] = "Fura for Powerline:pixelsize=14:antialias=true:autohint=true";
...
static unsigned int defaultfg = 261;
//static unsigned int defaultbg = 260;
static unsigned int defaultbg = 262;
